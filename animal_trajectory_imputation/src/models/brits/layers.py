...
class RITS(nn.Module):
    def __init__(self,
        ...
        self.rnn_cell = nn.LSTMCell(2 * self.input_size + self.u_size, self.hidden_size)
    ...
    def forward(self, x, mask=None, delta=None, u=None):
        ...
        for step in range(steps):
            ...
            if u is not None:
                inputs = torch.cat([inputs, u_s], dim=1)
